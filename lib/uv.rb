...
module UV
  ...
  attach_function :version_number, :uv_version, [], :uint
    ...
    attach_function :run, :uv_run, [:uv_loop_t, :uv_run_mode], :int
    ...
    attach_function :backend_fd, :uv_backend_fd, [:uv_loop_t], :int
    ...
    attach_function :walk, :uv_walk, [:uv_loop_t, :uv_walk_cb, :pointer], :void
    ...
    attach_function :get_process_title, :uv_get_process_title, [:pointer, :size_t], :int
    attach_function :set_process_title, :uv_set_process_title, [:string], :int
    attach_function :resident_set_memory, :uv_resident_set_memory, [:size_t], :int

    attach_function :uptime, :uv_uptime, [:pointer], :int
    attach_function :cpu_info, :uv_cpu_info, [:uv_cpu_info_t, :pointer], :int
    attach_function :loadavg, :uv_loadavg, [:pointer], :void
    attach_function :free_cpu_info, :uv_free_cpu_info, [:uv_cpu_info_t, :int], :void
    attach_function :interface_addresses, :uv_interface_addresses, [:uv_interface_address_t, :pointer], :int
    ...
    attach_function :cwd, :uv_cwd, [:pointer, :size_t], :int
    ...
    attach_function :dlopen, :uv_dlopen, [:string, :uv_lib_t], :int
    attach_function :dlclose, :uv_dlclose, [:uv_lib_t], :int
    attach_function :dlsym, :uv_dlsym, [:uv_lib_t, :string, :pointer], :int
